...
Обновление 2026-09-25: подготовка отдельной Mainnet-ветки и актуальные блокеры описаны в [yield-ai-v2-mainnet-preflight.md](yield-ai-v2-mainnet-preflight.md). Приведённые ниже сведения о незакоммиченном worktree и плановых расходах — исторический срез; перед on-chain действиями использовать свежие измерения из preflight.
