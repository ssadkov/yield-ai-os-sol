...
| --- | --- | --- |
| 0. Contract authority | Agent cannot transfer USDC/SOL to a third party via either generic CPI; non-owner cannot rotate agent; owner can revoke and withdraw all direct tokens. | Local validator PASS 2026-09-23 (incl. lifecycle instructions). Devnet PASS 2026-09-23 for the first contract version; lifecycle instructions pending devnet upgrade. |
