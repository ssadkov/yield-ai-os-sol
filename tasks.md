...
- **Pick reliable APR data sources**
  - **USDY (Ondo)**: identify official/public endpoints or partner data that provides current yield (APR/APY) and update cadence; document fallback if unavailable. [https://docs.ondo.finance/developer-guides/mantle-integration-guidelines](https://docs.ondo.finance/developer-guides/mantle-integration-guidelines)
